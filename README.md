...
<img src ='images/모델_오브젝트_배치.png' width = 70%  >
...
<img src = 'images/오브젝트 이동 스크립트.png' width = 50% height = 50%></br>
=> 오브젝트 이동 스크립트 
...
<img src = 'images/큐알코드 (1).gif' width = 50% height = 50% >
<br>
...
<img src = 'images/부품인식+(1).gif' width = 50% height = 50% >
<br>
...
<img src ='images/조립설명.gif' width = 50% height = 50%>
<br>
